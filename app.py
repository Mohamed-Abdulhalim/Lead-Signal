...
# Allow frontend from ANY DOMAIN (InfinityFree, local, anything)
...
# Hardcoded categories (static, used for meta endpoint)
...
def index():
    if request.method == "HEAD":
        return "", 200
    return render_template("index.html")   # No more Jinja vars passed
...
def meta():
    return jsonify(
        {
            "categories": ["All categories"] + unique_categories(),
